...
LightGBM ships no datasets of its own, so these reuse scikit-learn's bundled
    ...
    class Meta:
        ...
        tags = {
            ...
            "vgi.doc_llm": (
                ...
                "well-separated 3-class benchmark or to smoke-test a LightGBM pipeline end to end."
            ),
            "vgi.doc_md": (
        ...
        examples = [
            FunctionExample(sql="SELECT * FROM lightgbm.iris()", description="Load the full iris dataset"),
            FunctionExample(
                sql="SELECT target_name, avg(petal_length_cm) FROM lightgbm.iris() GROUP BY target_name",
...
class WineFunction(_ToyDataset):
    ...
    class Meta:
        ...
        examples = [FunctionExample(sql="SELECT * FROM lightgbm.wine()", description="Load the wine dataset")]
...
class BreastCancerFunction(_ToyDataset):
    ...
    class Meta:
        ...
        examples = [
            FunctionExample(sql="SELECT * FROM lightgbm.breast_cancer()", description="Load the breast cancer dataset")
        ]
...
class DiabetesFunction(_ToyDataset):
    ...
    class Meta:
        ...
        examples = [FunctionExample(sql="SELECT * FROM lightgbm.diabetes()", description="Load the diabetes dataset")]
...
class CaliforniaHousingFunction(TableFunctionGenerator[NoArgs]):
    ...
    class Meta:
        ...
        examples = [
            FunctionExample(
                sql="SELECT * FROM lightgbm.california_housing()",
