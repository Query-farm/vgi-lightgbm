...
`vgi-lightgbm` is developed and maintained by **[Query.Farm](https://query.farm)**.
It is a [VGI](https://query.farm) worker that exposes
[LightGBM](https://lightgbm.readthedocs.io) — datasets, a train/predict model
registry, and model interpretation — to DuckDB/SQL.
...
- **Issues:** https://github.com/query-farm/vgi-lightgbm/issues
